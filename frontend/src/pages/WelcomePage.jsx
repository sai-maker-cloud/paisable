...
export default function WelcomePage() {
  ...
  return (
    <div className="bg-gray-50 dark:bg-gray-900 min-h-screen font-montserrat">
      {/* Header */}
      <header className="py-4 px-8 flex justify-between items-center bg-white dark:bg-gray-800 shadow-md">
        <h1 className="text-2xl font-bold text-blue-600 dark:text-blue-400">Finance Tracker</h1>
